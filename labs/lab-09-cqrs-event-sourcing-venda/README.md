...
{
    c.SwaggerDoc("v1", new() { Title = "Lab09 CQRS + Event Sourcing - Vendas", Version = "v1" });
});
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Lab09 CQRS + Event Sourcing v1"));
}
```
