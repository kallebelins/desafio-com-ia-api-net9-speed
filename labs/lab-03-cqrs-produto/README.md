...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=sqlserver;Database=Lab03_Produtos;User Id=sa;Password=Lab@Mvp24Hours!;TrustServerCertificate=True;"
  }
}
```
...
{
    c.SwaggerDoc("v1", new() { Title = "Lab03 CQRS - Produtos", Version = "v1" });
});
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Lab03 CQRS v1"));
}
```
